...
@Component({
  selector: 'app-terapeutas-admin',
  templateUrl: './terapeutas-admin.component.html',
  styleUrls: ['./terapeutas-admin.component.scss'],
})
export class TerapeutasAdminComponent implements OnInit {
  pacientes: any[] = [1, 2, 3];
  ...
  //actions CRUD
  getTerapeutas() {
    this.apiService.getAdmin('seet').subscribe({
      next: (res) => {
